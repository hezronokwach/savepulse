      ...
      <div className="card-grid">
        ...
        <div className="card">
          ...
          <div className="p-4">
            ...
            <Link href="/signup">
              <button className="btn-primary w-full py-2 rounded-md">Track Blood</button>
            </Link>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="p-4">
            ...
            <Link href="/signup">
              <button className="btn-primary w-full py-2 rounded-md">Emergency Call</button>
            </Link>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="p-4">
            ...
            <Link href="/signup">
              <button className="btn-primary w-full py-2 rounded-md">Donor Rewards</button>
            </Link>
          </div>
        </div>
      </div>
